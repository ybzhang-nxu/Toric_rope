...
ROOT = Path("results")
OUT = ROOT / "v7_cifar10_mixed_component_mechanism_summary"
...
MODEL_SPECS = [
    {
        ...
        "path": ROOT / "v7_component_eval_cifar10_mixed_residual_dct32_seed426_layer_head_l0123_10k" / "component_interventions.csv",
    },
    {
        "seed": 526,
        "model": f"{BASIS}_seed526",
        "path": ROOT / "v7_component_eval_cifar10_mixed_residual_dct32_seed526_layer_head_l0123_10k" / "component_interventions.csv",
    },
    {
        "seed": 626,
        "model": f"{BASIS}_seed626",
        "path": ROOT / "v7_component_eval_cifar10_mixed_residual_dct32_seed626_layer_head_l0123_10k" / "component_interventions.csv",
    },
]
...
def write_report(seed_rows: list[dict[str, object]], family: dict[str, object]) -> None:
    ...
    text = "\n".join(
        [
            "# CIFAR10 Mixed Residual-DCT Component Mechanism Summary",
            "",
            ...
            (
                "- L0-L3 all-head ablate nearly exhausts the signal: "
            ...
            (
                "- The result supports the same mechanism as CIFAR100/SVHN: mixed residual-DCT stabilizes full boundary behavior while preserving an early local head pool."
            ),
            "",
        ]
    )
